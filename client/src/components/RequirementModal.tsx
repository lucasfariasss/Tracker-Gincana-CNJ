        ...
        <DialogHeader>
          ...
          <DialogDescription>
            <div className="mt-2 space-y-2 text-sm">
              <p><span className="font-semibold">Meta:</span> {requirement.item}</p>
              {requirement.descricao && (
                <p><span className="font-semibold">Descrição:</span> {requirement.descricao}</p>
              )}
              <p><span className="font-semibold">Prazo:</span> {requirement.deadline ? new Date(requirement.deadline).toLocaleDateString("pt-BR") : "Não definido"}</p>
              <p><span className="font-semibold">Pontos:</span> {requirement.pontosAplicaveis2026}</p>
            </div>
          </DialogDescription>
        </DialogHeader>
